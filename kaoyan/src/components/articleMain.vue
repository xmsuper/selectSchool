...
<el-backtop :right="100" :bottom="100" />
 ...
 <div class="community" v-for="i of article_list.item">
        ...
        <!-- 评论发表 -->
        <div class="comment_content" v-if="isShowComment">
            <el-form>
                <el-form-item label="评论">
                    <el-input v-model="usercomment" type="textarea" />
                </el-form-item>
                <el-form-item>
                    <div style="width: 100%;">
                        <el-button color="#07AAFF" style="color:#fff;float: right;"
                            @click="submitComment(i.id)">发表</el-button>
                    </div>
                </el-form-item>
            </el-form>
        </div>
        ...
        <span style="font-size: 20px;">评论列表</span>
        <ul class="comment_list">
            <li v-for="j in artcile_comment(i.id)">
                <div class="userInfo">
                    <img :src=j.avator alt="">
                    <p>{{ j.username }}</p>
                </div>
...
const artcile_comment = (e) => {

    return allComment.item.filter(val => val.article_id === e)
