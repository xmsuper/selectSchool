...
from showSchool.views import allSchool, allSchoolType, province_a, province_b, province_other \
    ...
    ,getSingleArticle,getSingleComment,DeleteArticle,getUserArticle,showCompare,\
    getMajorSchool,kaisheyuanxiao,TF,wordCloud,zuoti,checkAnswer
...
urlpatterns = [
    ...
    path('getSingleArticle',getSingleArticle.as_view()),
    path('getSingleComment',getSingleComment.as_view()),
    path('DeleteArticle',DeleteArticle.as_view()),
    path('getUserArticle',getUserArticle.as_view()),
    path('showCompare',showCompare.as_view()),
    path('getMajorSchool',getMajorSchool.as_view()),
    path('kaisheyuanxiao',kaisheyuanxiao.as_view()),
    path('TF',TF.as_view()),
    path('wordCloud/',wordCloud.as_view()),
    path('zuoti/',zuoti.as_view()),
    path('checkAnswer',checkAnswer.as_view()),
