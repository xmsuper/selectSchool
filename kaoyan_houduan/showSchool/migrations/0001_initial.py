    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recruit_name', models.CharField(blank=True, max_length=50, null=True)),
                ('special_name', models.CharField(blank=True, max_length=100, null=True)),
                ('school_name', models.TextField(blank=True, null=True)),
                ('depart_name', models.TextField(blank=True, null=True)),
                ('year', models.IntegerField(blank=True, null=True)),
                ('recruit_type', models.CharField(blank=True, max_length=50, null=True)),
                ('level1', models.CharField(blank=True, max_length=50, null=True)),
                ('level1_code', models.CharField(blank=True, max_length=50, null=True)),
                ('level2', models.CharField(blank=True, max_length=100, null=True)),
                ('level2_code', models.CharField(blank=True, max_length=50, null=True)),
                ...
                ('special_code', models.CharField(blank=True, max_length=50, null=True)),
            ],
            options={
