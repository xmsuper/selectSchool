...
class SchoolScore(models.Model):
    ...
    class Meta:
        ...
        verbose_name='院校各科分数'
    # def __str__(self):
    #     return self.school_name,self.major_code,self.school_name
...
class Userinfo(models.Model):
    ...
    join_school=models.TextField()
    join_major=models.TextField()
    join_type=models.CharField(max_length=50)
    learn_major=models.TextField()
    currentSchool=models.TextField()
    avator = models.ImageField(upload_to='photos/')#该函数需要安装第三方包pillow
    like_article=models.TextField()
    class Meta:
        managed = False
        db_table = 'userinfo'
        verbose_name = '用户信息'
...
class Image(models.Model):
    ...
    image = models.ImageField(upload_to='photos/')#该函数需要安装第三方包pillow
    class Meta:
        managed=True
        db_table='userAvator'
